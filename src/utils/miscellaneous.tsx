 ...
 * @param str - The input string to convert to lowercase and remove Vietnamese accents
 * @returns The converted string with lowercase letters and no Vietnamese accents
 */
